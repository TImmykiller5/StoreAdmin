...
const formSchema = z.object({
    ...
    value: z.string().min(4, 'Color is required').regex(/^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/, {message:'String must be a valid Hexadecimal color'}),
})
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <div className='flex items-center gap-x-2'>
                                    <Input disabled={loading} placeholder='Color HEX' {...field}/>
